...
export default function ContactChannels() {
    return (
        <div>
            <Head>
                <title>Get in touch | Pageflow | Dreamflow</title>
            ...
            <Navbar />
            <Wrapper bg="#C8B5FD" paddingTop="200px" paddingBottom="50px">
                    ...
                    <Row gutterWidth={0}>
                        ...
                        <Col md={6} lg={4}>
                            <div className={styles.contactcard_wrapper}>
                                <ContactCard buttonText="Contact Pageflow" name="contact-pageflow" />
                            </div>
                        </Col>
                    </Row>
                </Container>
